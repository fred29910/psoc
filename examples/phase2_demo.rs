//! Phase 2 Visual Effects Demo
//! Demonstrates the new visual effects and animation system

use iced::{Color, Point, Vector};
use std::time::{Duration, Instant};

// Simplified versions of our Phase 2 components for demonstration
...
impl GlassEffect {
    ...
    fn tech_blue() -> Self {
        Self {
            transparency: 0.85,
            blur_intensity: 0.4,
            tint_color: Color::from_rgba(0.0, 0.75, 1.0, 0.85), // Tech blue tint
        }
    }
...
impl DropShadow {
    ...
    fn tech_accent() -> Self {
        Self {
            color: Color::from_rgba(0.0, 0.75, 1.0, 0.3), // Tech blue shadow
