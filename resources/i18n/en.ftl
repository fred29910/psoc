...
shortcut-deselect = Ctrl+D
shortcut-preferences = Ctrl+,
shortcut-new-layer = Ctrl+Shift+N
shortcut-duplicate-layer = Ctrl+J
shortcut-delete-layer = Delete # Can be context-dependent, might be same as edit-delete
shortcut-text-tool = T
shortcut-select-tool = M
shortcut-lasso-tool = L
shortcut-magic-wand-tool = W
shortcut-invert-selection = Ctrl+Shift+I
shortcut-zoom-in = Ctrl++
shortcut-zoom-out = Ctrl+-
shortcut-zoom-reset = Ctrl+0
shortcut-zoom-fit = Ctrl+Shift+0
shortcut-rulers = Ctrl+R
shortcut-grid = Ctrl+'
shortcut-guides = Ctrl+;
shortcut-fullscreen = F11
shortcut-about = F1
shortcut-help-docs = Ctrl+F1
